...
spiridonov::Parallelogram::~Parallelogram()
{
}
...
spiridonov::rectangle_t spiridonov::Parallelogram::getFrameRect() const
{
...
void spiridonov::Parallelogram::move(point_t pos)
{
...
void spiridonov::Parallelogram::move(double x, double y)
{
  point_t newPos{ arrayOfPoints_[0].x + x, arrayOfPoints_[0].y + y };
  move(newPos);
}

void spiridonov::Parallelogram::scale(double coefficient)
{
  if (coefficient <= 0)
  {
...
spiridonov::Parallelogram* spiridonov::Parallelogram::clone() const
{
